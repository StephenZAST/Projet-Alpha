...
class UserIdSearchDialog extends StatefulWidget {
  ...
  final Function(User)? onUserDetailsRequested; // Nouveau callback pour voir les détails
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  if (widget.onUserDetailsRequested != null) {
                    widget.onUserDetailsRequested!(user);
