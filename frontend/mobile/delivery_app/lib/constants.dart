...
// Alias pour compatibilité
class AppRadius {
  static const BorderRadius radiusXS = BorderRadius.all(Radius.circular(MobileDimensions.radiusXS));
  static const BorderRadius radiusSM = BorderRadius.all(Radius.circular(MobileDimensions.radiusSM));
  static const BorderRadius radiusMD = BorderRadius.all(Radius.circular(MobileDimensions.radiusMD));
  static const BorderRadius radiusLG = BorderRadius.all(Radius.circular(MobileDimensions.radiusLG));
  static const BorderRadius radiusXL = BorderRadius.all(Radius.circular(MobileDimensions.radiusXL));
}
...
class NotificationConfig {
  ...
  static const String channelDescription = 'Notifications pour les livreurs Alpha Laundry';
