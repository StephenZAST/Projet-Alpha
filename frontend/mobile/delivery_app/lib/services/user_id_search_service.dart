...
/// 🔍 Service de recherche d'utilisateurs par ID
/// 
...
class UserIdSearchService {
  ...
  /// Obtient l'instance du service API
  static ApiService get _api {
    try {
      return Get.find<ApiService>();
    } catch (e) {
      print('[UserIdSearchService] Erreur: ApiService non initialisé');
      rethrow;
    }
  }
